                	...
                	<div class="col-lg-4">
                    	<form method="get">
                            <div class="form-group">
                                <label>Send Gifting Forms By Email</label>
                                <input type="text" name="pin" class="form-control" required>
                            </div>
                           <p>Just enter the Username of the members you are gifting and click submit. A new window will open that displays your Gifting
						   Statement and Non-Solicitation forms. Fill in the amount of your gift, and type your signature at the bottom of the form. When
						   finished you can send the forms automatically by email.  </p>
                            <!-- <div class="form-group">
                                <label>Email</label>
                            ...
                            <div class="form-group">
                        	<input name="join_user" class="btn btn-primary" value="Submit" type="button">
                        </div>
                        </form>
                    </div>
                </div><!--/.row-->
